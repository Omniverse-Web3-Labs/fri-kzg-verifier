...
fn test_pythagoras_solidity_verifier() {
    ...
    use semaphore_aggregation::plonky2_verifier::verifier_api::report_elapsed;
    ...
    info!("{}", format!("verify result from the smart contract: {:?}", String::from_utf8(output).unwrap()).cyan());
